...
<template>
	<footer
		class="mt-32 flex min-h-[28rem] items-center justify-center bg-black py-12 text-muted"
	>
		<div class="container grid w-full grid-cols-2 gap-12 lg:grid-cols-4">
			<div class="flex flex-col">
				<Logo />
				<h5 class="mt-8 text-xl">Subscribe</h5>
				<span class="mt-4 text-sm"> Get 10% off your first order </span>
				<div class="relative mt-4">
					<Input
						class="focus-visible:ring-white"
						placeholder="Enter your email"
					/>
					<Button
						class="absolute right-0 top-1/2 -translate-y-1/2 transform text-gray-400"
						size="icon"
						variant="ghost"
					>
			...
			<div class="flex flex-col">
				...
				<div class="mt-8">Amman, Jordan</div>
				<div class="mt-4">tradeoffer@gmail.com</div>
				<div class="mt-4">+88015-88888-9999</div>
			</div>
			<div class="flex flex-col">
				<h2 class="text-xl font-bold">Quick Link</h2>
				<Link
					class="mt-8"
					href="/"
				>
			...
			<div class="flex flex-col">
				<h2 class="text-xl font-bold">Download App</h2>
				...
				<div class="mt-2 flex justify-between">
					...
					<div class="flex flex-col">
						<img
							alt="qr.png"
							class="w-40"
							src="/storage/google-store.png"
						/>
						<img
							alt="qr.png"
							class="w-40"
							src="/storage/apple-store.png"
						/>
					</div>
				</div>
